...
public class UnitTestsHabitDistr
{
    ...
    public void NoMatterOrdinary()
    {
        ...
        List<Habit> habits = [];
        List<Event> events = [];
        var h = TaskTrackerMother.Habit().WithUserName(userName).WithCountInWeek(2).Build();
    ...
    public void PrefferedFitsInSecondDay()
    {
        ...
        var h = TaskTrackerMother.Habit()
            ...
            .WithPrefFixedTiming(new TimeOnly(7, 0, 0), new TimeOnly(9, 0, 0))
            .Build();
        events.AddRange(TaskTrackerMother.CustomDayShedule(userName, DayOfWeek.Monday, 
            [new("00:00:00", "08:00:00"),
            new("08:30:00", "09:00:00"),
            new("09:00:00", "18:00:00"),
            new("23:00:00", "23:59:59")]));
        events.AddRange(TaskTrackerMother.CustomDayShedule(userName, DayOfWeek.Tuesday,
            [new("00:00:00", "08:00:00"),
            new("08:50:00", "09:00:00"),
            new("09:00:00", "18:00:00"),
            new("23:00:00", "23:59:59")]));
        events.Add(TaskTrackerMother.WeeklyFiller(userName, DayOfWeek.Wednesday));
        events.Add(TaskTrackerMother.WeeklyFiller(userName, DayOfWeek.Thursday));
        events.Add(TaskTrackerMother.WeeklyFiller(userName, DayOfWeek.Friday));
        events.Add(TaskTrackerMother.WeeklyFiller(userName, DayOfWeek.Saturday));
        events.Add(TaskTrackerMother.WeeklyFiller(userName, DayOfWeek.Sunday));
        habits.Add(h);
