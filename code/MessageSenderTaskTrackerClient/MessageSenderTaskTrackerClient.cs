...
public class WebSenderTaskTrackerClient : ISenderTaskTrackerClient
{
    private readonly HttpClient _httpClient;

    public WebSenderTaskTrackerClient(HttpClient httpClient)
    {
    ...
    public async Task<List<UserHabitInfo>?> GetUsersToNotifyAsync()
    {
        ...
        return userHabitInfoDtos?.Select(MapToDomain).ToList();
    }
